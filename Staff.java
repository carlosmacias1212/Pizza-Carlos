...
//        Gson gson = new Gson();
//
////        JsonController.staffList is converted to json text
...
//        // Use JsonController class to make updates to the class list to be used in the json file
...
//        Use JsonController.staffList to make updates to the class list to be used in the json file
